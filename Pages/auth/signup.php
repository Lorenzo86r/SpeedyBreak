                ...
                <form action="auth_signup.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" id="femail" name="email" class="form-control"
                            placeholder="es. mario.rossi@aldini.istruzioneer.it" required>
                    ...
                    <div class="form-group flex items-center gap-2 mt-4">
                        ...
                        <label for="ftermini" class="form-label" style="margin-bottom: 0;">Accetto i <a href="#">Termini
                    ...
                    <div class="alert alert-error mt-4">
                        ...
                        <span>
                            ...
                            <?php elseif ($_GET['error'] == 'not_org'): ?>
                                ⚠️ Il tuo account non fa parte dell'organizzazione. Per richiedere l'accesso, contatta <a
                                    href="mailto:saqlain.khalid@aldini.istruzioneer.it"
                                    style="color: var(--color-primary); font-weight: 600;">saqlain.khalid@aldini.istruzioneer.it</a>.
                            <?php endif; ?>
                        </span>
                    </div>
                <?php endif; ?>
