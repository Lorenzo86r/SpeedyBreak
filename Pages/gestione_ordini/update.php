        ...
        <div class="center-container" style="max-width: 800px; width: 100%;">
            ...
            <div class="flex justify-between items-center mb-2" style="width: 100%;">
                <div style="display: flex; align-items: center; gap: 1rem;">
                    <h2 style="font-size: var(--font-size-2xl); margin: 0;">Ordine
                        #<?= str_pad(htmlspecialchars($ordine["id_ordine"]), 4, '0', STR_PAD_LEFT) ?></h2>
                    <span class="badge"
                        style="background: rgba(59, 130, 246, 0.1); color: #1d4ed8; font-size: 14px; padding: 6px 14px; border-radius: 99px;">
            ...
            <?php if ($message): ?>
                <div
                    class="alert <?= strpos(strtolower($message), 'errore') !== false ? 'alert-error' : 'alert-success' ?>">
                    <?= htmlspecialchars($message) ?>
                </div>
            <?php endif; ?>
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(320px, 1fr)); gap: 1.5rem;">
                ...
                <div class="card animate-fade-in"
                    style="margin: 0; box-shadow: var(--shadow-sm); border: 1px solid var(--color-border);">
                    <h3
                        style="display: flex; align-items: center; gap: 8px; border-bottom: 1px solid var(--color-border); padding-bottom: 12px; margin-bottom: 16px; font-size: 18px;">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                            stroke-width="2" style="color:var(--color-primary);">
                            <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path>
                            <circle cx="12" cy="7" r="4"></circle>
                        </svg>
                        Dettagli Cliente
                    ...
                    <div
                        style="color: var(--color-text-muted); display:flex; flex-direction:column; gap:10px; font-size: 15px;">
                        <div style="display: flex; justify-content: space-between;">
                            <span>Username:</span>
                            <strong
                                style="color: var(--color-text);"><?= htmlspecialchars($ordine["username"]) ?></strong>
                        </div>
                        <div style="display: flex; justify-content: space-between;">
                            <span>Email:</span>
                        ...
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            <span>Ruolo:</span>
                            <span class="badge"
                                style="background:#f3f4f6; color:#374151; font-weight: 500; font-size: 12px;"><?= htmlspecialchars($ordine["ruolo"]) ?></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="card animate-fade-in"
                    ...
                    <div class="table-container"
                        style="box-shadow: none; border: 1px solid var(--color-border); border-radius: 8px; overflow: hidden; margin-bottom: 0;">
                        <table class="table" style="margin:0; font-size: 14px;">
                            <thead
                                style="background: #f8fafc; color: var(--color-text-muted); border-bottom: 1px solid var(--color-border);">
                                <tr>
                                    <th
                                        style="padding: 10px 14px; text-transform: uppercase; font-size: 12px; letter-spacing: 0.5px;">
                                        Prodotto</th>
                                    <th
                                        style="text-align:right; padding: 10px 14px; text-transform: uppercase; font-size: 12px; letter-spacing: 0.5px;">
                                        Qt.</th>
                                    <th
                                        style="text-align:right; padding: 10px 14px; text-transform: uppercase; font-size: 12px; letter-spacing: 0.5px;">
                                        Prezzo</th>
                            ...
                            <tbody>
                                ...
                                foreach ($ordine["prodotti"] as $p):
                                    ...
                                    <tr style="border-bottom: 1px solid var(--color-border);">
                                        ...
                                        <td style="text-align:right; padding: 12px 14px;"><span
                                                style="color: var(--color-primary); font-weight: 700;"><?= htmlspecialchars($p["quantita"]) ?>x</span>
                                        </td>
                                        <td style="text-align:right; padding: 12px 14px; font-weight: 500;">
                            ...
                            <tfoot>
                                <tr style="background: rgba(16, 185, 129, 0.05);">
                                    <td colspan="2"
                                        style="text-align:right; padding: 12px 14px; font-weight: 600; font-size: 16px;">
                                        Totale dell'ordine:</td>
                                    <td
                                        style="text-align:right; padding: 12px 14px; font-weight: 700; color: var(--color-secondary); font-size: 18px;">
                                        €<?= number_format($totale, 2) ?></td>
                                </tr>
                            </tfoot>
                        </table>
                    </div>
            ...
            <!-- MODIFICA ORDINE -->
            <div class="card animate-fade-in"
                style="margin: 0; box-shadow: var(--shadow-sm); border: 1px solid var(--color-border); border-top: 4px solid var(--color-secondary);">
                ...
                <form method="POST">
                    <div
                        ...
                        <div class="form-group" style="margin: 0;">
                            <label style="font-weight: 600; margin-bottom: 6px; display: block; font-size: 14px;">Stato
                                Ordine</label>
                            <select name="stato" class="form-control" style="background-color: #f8fafc;">
                                ...
                                <option <?= $ordine["stato"] == "In preparazione" ? "selected" : "" ?>>In preparazione
                                </option>
                        ...
                        <div class="form-group" style="margin: 0;">
                            <label style="font-weight: 600; margin-bottom: 6px; display: block; font-size: 14px;">Ritiro
                                Previsto</label>
                        ...
                        <div class="form-group" style="margin: 0;">
                            <label style="font-weight: 600; margin-bottom: 6px; display: block; font-size: 14px;">Metodo
                                di Pagamento</label>
                            <select name="metodo" class="form-control" style="background-color: #f8fafc;">
                                ...
                                <option <?= $ordine["metodo"] == "Carta di Credito" ? "selected" : "" ?>>Carta di Credito
                                </option>
                            </select>
                        </div>
                    ...
                    <div class="form-group" style="margin-bottom: 24px;">
                        <label style="font-weight: 600; margin-bottom: 6px; display: block; font-size: 14px;">Eventuali
                            Note del Cliente</label>
                        <textarea name="nota" class="form-control" rows="3"
                            placeholder="Nessuna nota fornita dal cliente."
                            style="background:#fefce8; border-color: #fef08a; padding: 12px; resize: vertical;"><?= htmlspecialchars($ordine["nota"]) ?></textarea>
                    </div>

                    <div class="flex justify-between items-center"
                        style="border-top: 1px solid var(--color-border); padding-top: 20px; flex-wrap: wrap; gap: 16px;">
                        <button type="submit" name="delete" class="btn btn-sm"
                            style="background: transparent; color: var(--color-error); border: 1px solid var(--color-error); padding: 8px 16px;"
